  ...
  return (
    <div className="w-full max-w-5xl h-full">
      ...
      <div>
        ...
        <p>
          As you know we've lived together for awhile now. We even bought a house in January! So we've got quite a few things already. So we've decided to add only a couple things to a registry, but mainly we'd ask for a contribution to our honeymoon fund!
        </p>
